<template>
  <nav :class="isfade?'fade':''">
    <div class="w">
      ...
      <div class="login" :style="{'backgroundImage':`url(${!bgc?'day_logo.png':'dark-logo.png'})`}" @click="this.$router.push({name:'home'})"></div>
      <div class="nav">
        <ul>
          <li><router-link to="home" active-class="nav-active"><span class="iconfont icon-shouye"></span>首页</router-link></li>
          <li><router-link to="note" active-class="nav-active"><span class="iconfont icon-biji"></span>笔记</router-link></li>
          <li><router-link to="project" active-class="nav-active"><span class="iconfont icon-xiangmu"></span>作品</router-link></li>
          <li><router-link to="plan" active-class="nav-active"><span class="iconfont icon-daiban"></span>规划</router-link></li>
          <li><router-link to="about" active-class="nav-active"><span class="iconfont icon-guanyu1"></span>关于</router-link></li>
...
"></span>管理</router-link></li>
    ...
    <div class="m-nav" :style="{'height':`${open?'0':'220'}px`}">
      <ul @click="open = true">
        <li><router-link to="home" active-class="m-nav-active"><span class="iconfont icon-shouye"></span>首页</router-link></li>
        <li><router-link to="note" active-class="m-nav-active"><span class="iconfont icon-biji"></span>笔记</router-link></li>
        <li><router-link to="project" active-class="m-nav-active"><span class="iconfont icon-xiangmu"></span>作品</router-link></li>
        <li><router-link to="plan" active-class="m-nav-active"><span class="iconfont icon-daiban"></span>规划</router-link></li>
        <li><router-link to="about" active-class="m-nav-active"><span class="iconfont icon-guanyu1"></span>关于</router-link></li>
...
"></span>管理</router-link></li>
  ...
  <div class="toTop c" v-jump :class="isfade?'tanchu':''" @click="toTop">
    <span><svg t="1681133568248" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3449" width="16" height="16">
        <path d="M137.94 531.49a43.85 43.85 0 0 0 6.7 61.5 43.68 43.68 0 0 0 61.4-6.7l306.9-381.5 305 379.6a43.67 43.67 0 1 0 68.1-54.7l-339.1-422a43.71 43.71 0 0 0-68.1 0z m0 330a43.85 43.85 0 0 0 6.7 61.5 43.68 43.68 0 0 0 61.4-6.7l306.9-381.5 305 379.6a43.67 43.67 0 1 0 68.1-54.7l-339.1-422a43.71 43.71 0 0 0-68.1 0z" p-id="3450"></path>
      </svg></span>
  </div>
  <!-- 二维嘛 -->
  ...
  <footer>
    <div class="w">
      ...
      <div class="r">
        ...
        <span class="beian">桂ICP备2022010893号</span>
      </div>
    </div>
